...
export default function ComoFuncionaLandingPage() {
    return (
        <section id="como-funciona" className="bg-[#f6f7f9] px-6 py-20 sm:px-10">
            <div className="mx-auto w-full max-w-[1220px]">
                ...
                <div className="mt-10 grid items-center gap-12 lg:grid-cols-[1.15fr_0.85fr]">
                    <div className="relative">
                        ...
                        <div className="relative z-10 aspect-[1.45/1] min-h-[360px] rounded-lg border-2 border-dashed border-[#9bb6ca] bg-white/80 shadow-sm" />
                    </div>
